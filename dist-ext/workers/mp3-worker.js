...
self.onmessage = function (event) {
    ...
    try {
        const { channels, sampleRate, bitrate, tagBuffer } = data;
        const mp3Blob = encodeMp3(channels, sampleRate, bitrate, id, tagBuffer);
